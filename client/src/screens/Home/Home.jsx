...
export default function (props) {
  return (
    <Container my="10%">
      ...
      <Box w="50vw" h="30vh" position="relative" alignItems="center">
      ...
      <Text align="center" mb="3%">
        ...
        the world here! Thanks to the Global Biodiversity Information Facility,
        you’ll get to know your neighbors through images taken right in your
        area, taken by both professional researchers and citizen naturalists.
      </Text>
      <Text align="center">
